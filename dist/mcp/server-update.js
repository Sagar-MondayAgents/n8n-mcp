...
const tools_update_1 = require("./tools-update");
...
class N8NDocumentationMCPServer {
    ...
    setupHandlers() {
        ...
        this.server.setRequestHandler(types_js_1.ListToolsRequestSchema, async () => {
            const tools = [...tools_update_1.n8nDocumentationToolsFinal];
            if ((0, n8n_api_1.isN8nApiConfigured)()) {
                tools.push(...tools_n8n_manager_1.n8nManagementTools);
                logger_1.logger.info('n8n management tools enabled');
            }
            else {
                logger_1.logger.info('n8n management tools disabled (API not configured)');
            }
            return { tools };
        });
    ...
    async listNodes(filters = {}) {
        ...
        const params = [];
        console.log('DEBUG list_nodes:', { filters, query, params });
        if (filters.package) {
...
//# sourceMappingURL=server-update.js.map